...
function HeroPaintPlayRun() {
    ...
    $('#hero').attr('src',"./resource/Game_hero/run/image"+(heroPaintPlayTick*2+2282)+".png");
}
...
function HeroPaintPlayRun2() {
    ...
    $('#hero').attr('src',"./resource/Game_hero/run2/image"+(heroPaintPlayTick*2+2256)+".png");
}
...
function HeroPaintPlayStay() {
    ...
    $('#hero').attr('src',"./resource/Game_hero/stay/image"+(heroPaintPlayTick*2+2267)+".png");
}