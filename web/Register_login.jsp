   ...
   background-attachment: fixed;">
    <div class="ww">
        ...
        <form action="Register_login" method="post">
            ...
            <input type="text"  placeholder="请输入帐号" name="user_login" value="admin">
            ...
            <span class="button"><input class="sub" type="button" value="注册帐号" onclick="javascrtpt:window.location.href='backpack/Register_register.jsp'"
            /></span>
